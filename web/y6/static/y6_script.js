...
const changingBranchSlot=document.querySelector('.'+changingBranchSlotId);ensureSlotVisible(changingBranchSlot,{'font-weight':'600','font-size':'0.9rem'});if(isMovingYao&&changingBranchText){changingBranchSlot.textContent=changingBranchText;const changingWuxingColor=getWuxingColor(changingBranchText);changingBranchSlot.style.setProperty('color',changingWuxingColor,'important');changingBranchSlot.style.setProperty('font-weight','600','important');changingBranchSlot.style.setProperty('display','flex','important');changingBranchSlot.style.setProperty('align-items','center','important');changingBranchSlot.style.setProperty('justify-content','center','important');changingBranchSlot.style.setProperty('font-size','0.9rem','important');changingBranchSlot.style.setProperty('visibility','visible','important');changingBranchSlot.style.setProperty('opacity','1','important');changingBranchSlot.style.setProperty('width','auto','important');changingBranchSlot.style.setProperty('height','auto','important');console.log(`✅ ${changingYaoDetail ? 'changing_yao_detailed에서' : '테이블에서'} ${yaoName} (효위=${yaoPos}) 변괘 납갑 지지 표시 완료:`,changingBranchText,'오행 색상:',changingWuxingColor,'slot:',changingBranchSlotId);}else{if(changingBranchSlot){changingBranchSlot.textContent='';}
