...
redirectToLogin(message){alert(message);this.saveY6FormData();sessionStorage.setItem('returnAfterLogin','true');sessionStorage.setItem('returnUrl',window.location.href);window.location.href='/secret/member_login.html';}
