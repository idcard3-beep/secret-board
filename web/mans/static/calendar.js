...
window.addEventListener('load',function(){setTimeout(initPageLoad,100);});})();(function(){'use strict';function updateTodayButtonTime(){var now=new Date();var hour=now.getHours();var minute=now.getMinutes();var timeElement=document.getElementById('kst-time');if(timeElement){var hour_str=hour.toString().padStart(2,'0');var minute_str=minute.toString().padStart(2,'0');timeElement.innerHTML=now.getFullYear()+'년 '+
(now.getMonth()+1)+'월 '+
now.getDate()+'일 '+
hour_str+':'+
minute_str;}
