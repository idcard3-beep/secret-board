...
const daeun=daeunResult.status==='fulfilled'?daeunResult.value:[];const yeonun=yeonunResult.status==='fulfilled'?yeonunResult.value:[];const wolun=wolunResult.status==='fulfilled'?wolunResult.value:[];console.log('Python API 대운 결과:',daeun);console.log('Python API 연운 결과:',yeonun);console.log('Python API 월운 결과:',wolun);console.log('월운 데이터 타입:',typeof wolun);if(wolun&&wolun.length>0){console.log('첫 번째 월운 gan:',wolun[0].gan,'zhi:',wolun[0].zhi);}
